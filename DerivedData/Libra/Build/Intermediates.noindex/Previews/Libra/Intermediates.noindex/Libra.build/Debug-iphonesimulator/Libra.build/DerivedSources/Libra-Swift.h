...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Libra",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Libra11AppDelegate")
...
@interface Entity (SWIFT_EXTENSION(Libra))
@property (nonatomic, strong) NSDecimalNumber * _Nullable test;
@end

@class UIWindow;
@class UIScene;

SWIFT_CLASS("_TtC5Libra13SceneDelegate")
